...
namespace Prp.Data
{
    ...
    public static class MapApplicantLevel3
    {
        public static tblApplicantLevel3Details ToTable(ApplicantLevel3 objt)
        {
            Mapper.CreateMap<ApplicantLevel3, tblApplicantLevel3Details>();
            return Mapper.Map<ApplicantLevel3, tblApplicantLevel3Details>(objt);
        }

        public static ApplicantLevel3 ToEntity(tblApplicantLevel3Details objt)
        {
            Mapper.CreateMap<tblApplicantLevel3Details, ApplicantLevel3>();
            return Mapper.Map<tblApplicantLevel3Details, ApplicantLevel3>(objt);
        }

        public static List<ApplicantLevel3> ToEntityList(List<tblApplicantLevel3Details> listt)
        {
        ...
        public static ApplicantLevel3 ToEntity(tvwApplicantLevel3 objt)
        {
            Mapper.CreateMap<tvwApplicantLevel3, ApplicantLevel3>();
            return Mapper.Map<tvwApplicantLevel3, ApplicantLevel3>(objt);
        }

        public static List<ApplicantLevel3> ToEntityList(List<tvwApplicantLevel3> listt)
        {
            List<ApplicantLevel3> list = new List<ApplicantLevel3>();
            foreach (var item in listt)
            {
        ...
        public static ApplicantCertificateLevel3 ToEntity(tvwApplicantCertificateLevel3 objt)
        {
            Mapper.CreateMap<tvwApplicantCertificateLevel3, ApplicantCertificateLevel3>();
            return Mapper.Map<tvwApplicantCertificateLevel3, ApplicantCertificateLevel3>(objt);
        }

        public static List<ApplicantCertificateLevel3> ToEntityList(List<tvwApplicantCertificateLevel3> listt)
        {
    ...
    #region SuperSpeciality

    public static class MapSuperSpeciality
    {
        public static tvwAdminSuperSpeciality ToTable(AdminSuperSpeciality obj)
        {
            Mapper.CreateMap<AdminSuperSpeciality, tvwAdminSuperSpeciality>();
            return Mapper.Map<AdminSuperSpeciality, tvwAdminSuperSpeciality>(obj);

        }
        public static SuperSpeciality ToTable(SuperSpeciality obj)
        {
            Mapper.CreateMap<tblSuperSpeciality, SuperSpeciality>();
            return Mapper.Map<tblSuperSpeciality, SuperSpeciality>(obj);

        }

        public static AdminSuperSpeciality ToEntity(tvwAdminSuperSpeciality obj)
        {
            Mapper.CreateMap<tvwAdminSuperSpeciality, AdminSuperSpeciality>();
            return Mapper.Map<tvwAdminSuperSpeciality, AdminSuperSpeciality>(obj);

        }
        public static SuperSpeciality ToEntity(tblSuperSpeciality obj)
        {
            Mapper.CreateMap<tblSuperSpeciality, SuperSpeciality>();
            return Mapper.Map<tblSuperSpeciality, SuperSpeciality>(obj);

        }
        public static List<AdminSuperSpeciality> ToEntityList(List<tvwAdminSuperSpeciality> listt)
        {
            List<AdminSuperSpeciality> list = new List<AdminSuperSpeciality>();
            foreach (var item in listt)
            {
                list.Add(ToEntity(item));
            }
        ...
        public static List<SuperSpeciality> ToEntityList(List<tblSuperSpeciality> listt)
        {
            List<SuperSpeciality> list = new List<SuperSpeciality>();
            foreach (var item in listt)
            {
                list.Add(ToEntity(item));
            }
