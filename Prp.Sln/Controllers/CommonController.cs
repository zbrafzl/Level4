...
namespace Prp.Sln.Controllers
{
    public class CommonController : Controller
    {
        ...
        public JsonResult GetAllSuperSpecialitiesDDL(SuperSpecialityDDL obj)
        {
            ...
            List<SuperSpeciality> model = new SpecialityDAL().GetAllSuperSpecialities(obj.specialityId);
        ...
        [HttpPost]
        public JsonResult GetSpecialityForApplicant(SpecialityByApplicantSearch obj)
        {
            var list = new ApplicantDAL().GetSpecialityForApplicant(obj);
            return Json(list, JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
