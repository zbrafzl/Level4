...
namespace Prp.Sln
{
    ...
    public class SpecialityModelAdmin : ModelBaseAdmin
    {
        ...
        public SuperSpeciality superSpeciality { get; set; }
        ...
        public List<AdminSuperSpeciality> superSpecialities { get; set; }
    ...
    public class SpecialityJobModelAdmin : ModelBaseAdmin
    {
        ...
        public List<EntityDDL> listType { get; set; }
        public List<EntityDDL> listSpeciality { get; set; }
        public List<SuperSpeciality> listSuperSpeciality { get; set; }
    ...
    public class InterviewAdminModel : ModelBaseAdmin
    {
        public int requestType { get; set; }
        public int applicantId { get; set; }
        ...
        public string imgLoR { get; set; }


        public InterviewAdminModel()
        {
            applicant = new Applicant();
            applicantInfo = new ApplicantInfo();
            degree = new ApplicantDegree();
