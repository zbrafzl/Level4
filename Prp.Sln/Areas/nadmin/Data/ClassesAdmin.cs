...
namespace Prp.Sln.Areas.nadmin
{
    ...
    public static class AdminFunctions
    {
        ...
        public static InterviewAdminModel GenerateModeInterview(int inductionId, int phaseId, int applicantId)
        {
            ...
            try
            {
                ...
                InterviewDetail interView = new VerificationDAL().GetApplicantInterview(inductionIdParam, applicantId);

                model.interviewComments =interView.interviewComments;
                model.interviewMarks = interView.interviewMarks;
                model.marksLoR = interView.marksLoR;
                model.imgLoR = interView.picLoR;
