...
namespace Prp.Sln.Areas.nadmin.Controllers
{
    public class SpecialityAdminController : BaseAdminController
    {
        public ActionResult SpecialityJobSetup()
        {
            ...
            model.job.superSpecialityId = Request.QueryString["superSpecialityId"].TooInt();
            ...
            model.listSuperSpeciality = new SpecialityDAL().GetAllSuperSpecialities(model.job.specialityId);
            ...
            model.listSpecialityJob = new SpecialityDAL().GetSpecialityJobByParameters(model.job.inductionId, model.job.specialityId,model.job.superSpecialityId);
        ...
        [HttpPost]
        public JsonResult GetAllSuperSpecialitiesDDL(SuperSpecialityDDL obj)
        {
            SpecialityJobModelAdmin model = new SpecialityJobModelAdmin();
            model.listSuperSpeciality = new SpecialityDAL().GetAllSuperSpecialities(obj.specialityId);
            return Json(model.listSuperSpeciality, JsonRequestBehavior.AllowGet);
        }
