...
namespace Prp.Model
{
    ...
    public partial class DbPrpEntities : DbContext
    {
        ...
        public virtual DbSet<tblApplicantLevel3Details> tblApplicantLevel3Details { get; set; }
        ...
        public virtual DbSet<tblSuperSpeciality> tblSuperSpecialities { get; set; }
        ...
        public virtual DbSet<tblApplicant1> tblApplicant1 { get; set; }

        public virtual DbSet<tblApplicantApprovalStatus1> tblApplicantApprovalStatus1 { get; set; }

        public virtual DbSet<tblApplicantDegreeMarks1> tblApplicantDegreeMarks1 { get; set; }

        public virtual DbSet<tblApplicantDistinction1> tblApplicantDistinction1 { get; set; }

        public virtual DbSet<tblApplicantExperience1> tblApplicantExperience1 { get; set; }

        public virtual DbSet<tblApplicantHouseJob1> tblApplicantHouseJob1 { get; set; }

        public virtual DbSet<tblApplicantHouseJobDetail1> tblApplicantHouseJobDetail1 { get; set; }

        public virtual DbSet<tblApplicantInfo1> tblApplicantInfo1 { get; set; }

        public virtual DbSet<tblApplicantInfoDualNational1> tblApplicantInfoDualNational1 { get; set; }

        public virtual DbSet<tblApplicantJoined1> tblApplicantJoined1 { get; set; }

        public virtual DbSet<tblApplicantResearchPaper1> tblApplicantResearchPaper1 { get; set; }

        public virtual DbSet<tblApplicantSpecility1> tblApplicantSpecility1 { get; set; }

        public virtual DbSet<tblApplicantVoucher1> tblApplicantVoucher1 { get; set; }

        public virtual DbSet<tblApplicantVoucherBank1> tblApplicantVoucherBank1 { get; set; }

        public virtual DbSet<tblApplicationStatus1> tblApplicationStatus1 { get; set; }

        public virtual DbSet<tblBeds1> tblBeds1 { get; set; }

        public virtual DbSet<tblConsent1> tblConsent1 { get; set; }

        public virtual DbSet<tblConstant1> tblConstant1 { get; set; }

        public virtual DbSet<tblContactStatus1> tblContactStatus1 { get; set; }

        public virtual DbSet<tblEmailTemplate1> tblEmailTemplate1 { get; set; }

        public virtual DbSet<tblEmployee1> tblEmployee1 { get; set; }

        public virtual DbSet<tblGrievance1> tblGrievance1 { get; set; }

        public virtual DbSet<tblGrievanceAction1> tblGrievanceAction1 { get; set; }

        public virtual DbSet<tblHospitalDiscipline1> tblHospitalDiscipline1 { get; set; }

        public virtual DbSet<tblResearchJournal1> tblResearchJournal1 { get; set; }

        public virtual DbSet<tblSpecialityJob1> tblSpecialityJob1 { get; set; }
        ...
        public virtual DbSet<tblApplicantCertificate1> tblApplicantCertificate1 { get; set; }

        public virtual DbSet<tblApplicantDegree1> tblApplicantDegree1 { get; set; }

        public virtual DbSet<tblGrievanceRemarks1> tblGrievanceRemarks1 { get; set; }
        ...
        public virtual DbSet<tvwApplicantLevel3> tvwApplicantLevel3 { get; set; }
        ...
        public virtual DbSet<tvwAdminSuperSpeciality> tvwAdminSuperSpecialities { get; set; }

        public virtual DbSet<tvwApplicantCertificateLevel3> tvwApplicantCertificateLevel3 { get; set; }
        ...
        public virtual int spApplicantCertificateAddUpdateAdmin(Nullable<int> applicantCertificateTypeId, Nullable<int> inductionId,  Nullable<int> applicantId, Nullable<int> typeId, Nullable<int> certificateTypeId, Nullable<int> disciplineId, Nullable<int> obtainMarks, Nullable<int> totalMarks, Nullable<System.DateTime> passingDate, string imageCertificate, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spApplicantCertificateAddUpdateAdmin", applicantCertificateTypeIdParameter, inductionIdParameter, applicantIdParameter, typeIdParameter, certificateTypeIdParameter, disciplineIdParameter, obtainMarksParameter, totalMarksParameter, passingDateParameter, imageCertificateParameter, adminIdParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> spApplicantDegreeAddUpdate(Nullable<int> applicantDegreeDetailId, Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, Nullable<int> graduateTypeId, Nullable<int> degreeTypeId, Nullable<int> degreeYear, Nullable<int> provinceId, Nullable<int> instituteTypeId, Nullable<int> instituteId, string instituteName, Nullable<int> totalMarks, Nullable<int> obtainMarks, string imageDegree, string imageDegreeForeignFront, string imageDegreeForeignBack, string imageDegreeMatric, string imageDegreeFSC, string imageCertificate, string typeIds, Nullable<bool> fcpsExemptionStatus, string fcpsExemptionCertificate)
        {
            ...
            var imageDegreeFSCParameter = imageDegreeFSC != null ?
                new ObjectParameter("imageDegreeFSC", imageDegreeFSC) :
                new ObjectParameter("imageDegreeFSC", typeof(string));
        ...
        public virtual int spApplicantDegreeAddUpdateAdmin(Nullable<int> applicantDegreeDetailId, Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, Nullable<int> graduateTypeId, Nullable<int> degreeTypeId, Nullable<int> degreeYear, Nullable<int> provinceId, Nullable<int> instituteTypeId, Nullable<int> instituteId, string instituteName, Nullable<int> totalMarks, Nullable<int> obtainMarks, string imageDegree, string imageDegreeForeignFront, string imageDegreeForeignBack, string imageDegreeMatric, string imageDegreeFSC, string imageCertificate, string typeId, Nullable<bool> fcpsExemptionStatus, string fcpsExemptionCertificate, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spApplicantDegreeAddUpdateAdmin", applicantDegreeDetailIdParameter, inductionIdParameter, phaseIdParameter, applicantIdParameter, graduateTypeIdParameter, degreeTypeIdParameter, degreeYearParameter, provinceIdParameter, instituteTypeIdParameter, instituteIdParameter, instituteNameParameter, totalMarksParameter, obtainMarksParameter, imageDegreeParameter, imageDegreeForeignFrontParameter, imageDegreeForeignBackParameter, imageDegreeMatricParameter, imageDegreeFscParameter, imageCertificateParameter, typeIdParameter, fcpsExemptionStatusParameter, fcpsExemptionCertificateParameter, adminIdParameter);
        }


        public virtual int spApplicantDegreeMarksAddUpdate(Nullable<int> degreeMarksId, Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, Nullable<int> graduateTypeId, Nullable<int> year, Nullable<int> totalMarks, Nullable<int> obtainMarks, Nullable<int> attempt, Nullable<int> division, Nullable<int> position, string imageDMC, string positionCertificate)
        {
            ...
            var positionCertificateParameter = positionCertificate != null ?
                new ObjectParameter("positionCertificate", positionCertificate) :
                new ObjectParameter("positionCertificate", typeof(string));


            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spApplicantDegreeMarksAddUpdate", degreeMarksIdParameter, inductionIdParameter, phaseIdParameter, applicantIdParameter, graduateTypeIdParameter, yearParameter, totalMarksParameter, obtainMarksParameter, attemptParameter, divisionParameter, positionParameter, imageDMCParameter, positionCertificateParameter);
        }


        public virtual int spApplicantDegreeMarksAddUpdateAdmin(Nullable<int> degreeMarksId, Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, Nullable<int> graduateTypeId, Nullable<int> year, Nullable<int> totalMarks, Nullable<int> obtainMarks, Nullable<int> attempt, Nullable<int> division, Nullable<int> position, string imageDMC, Nullable<int> adminId, string positionCertificate)
        {
            ...
            var positionCertificateParamter = positionCertificate != null ?
                new ObjectParameter("positionCertificate", positionCertificate) :
                new ObjectParameter("positionCertificate", typeof(string));


            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spApplicantDegreeMarksAddUpdateAdmin", degreeMarksIdParameter, inductionIdParameter, phaseIdParameter, applicantIdParameter, graduateTypeIdParameter, yearParameter, totalMarksParameter, obtainMarksParameter, attemptParameter, divisionParameter, positionParameter, imageDMCParameter, adminIdParameter, positionCertificateParamter);
        }
        ...
        public virtual ObjectResult<spApplicantSpecilityAddUpdate_Result> spApplicantSpecilityAddUpdate(Nullable<int> applicantSpecilityId, Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, Nullable<int> preferenceNo, Nullable<int> typeId, Nullable<int> specialityId, Nullable<int> superSpecialityId, Nullable<int> hospitalId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spApplicantSpecilityAddUpdate_Result>("spApplicantSpecilityAddUpdate", applicantSpecilityIdParameter, inductionIdParameter, phaseIdParameter, applicantIdParameter, preferenceNoParameter, typeIdParameter, specialityIdParameter, superSpecialityIdParameter, hospitalIdParameter);
        }
        ...
        public virtual ObjectResult<spApplicantSpecilityCheckPreferenceNo_Result> spApplicantSpecilityCheckPreferenceNo(Nullable<int> applicantSpecilityId, Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, Nullable<int> preferenceNo, Nullable<int> typeId, Nullable<int> specialityId, Nullable<int> superSpecialityId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spApplicantSpecilityCheckPreferenceNo_Result>("spApplicantSpecilityCheckPreferenceNo", applicantSpecilityIdParameter, inductionIdParameter, phaseIdParameter, applicantIdParameter, preferenceNoParameter, typeIdParameter, specialityIdParameter, superSpecialityIdParameter);
        }
        ...
        public virtual ObjectResult<spSpecialityJobByParameters_Result> spSpecialityJobByParameters(Nullable<int> inductionId, Nullable<int> specialityId, Nullable<int> superSpecialityId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spSpecialityJobByParameters_Result>("spSpecialityJobByParameters", inductionIdParameter, specialityIdParameter, superSpecialityIdParameter);
        }
        ...
        [DbFunction("DbPrpEntities", "fnSpecialityForApplicant")]
        public virtual IQueryable<fnSpecialityForApplicant_Result> fnSpecialityForApplicant(Nullable<int> typeId, Nullable<int> disciplineId, Nullable<int> disciplineIdOptional)
        {
            ...
            var disciplineIdOptionalParameter = disciplineIdOptional.HasValue ?
                new ObjectParameter("disciplineIdOptional", disciplineIdOptional) :
                new ObjectParameter("disciplineIdOptional", typeof(int));


            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fnSpecialityForApplicant_Result>("[DbPrpEntities].[fnSpecialityForApplicant](@typeId, @disciplineId, @disciplineIdOptional)", typeIdParameter, disciplineIdParameter, disciplineIdOptionalParameter);
        }


        public virtual int spApplicantLevel3AddUpdate(Nullable<int> applicantLevel3Details, Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, Nullable<int> typeId, Nullable<int> disciplineId, string imageCertificate, Nullable<int> specialityId, Nullable<int> medals, Nullable<System.DateTime> passingDate, Nullable<int> obtainMarks, Nullable<int> totalMarks)
        {

            var applicantLevel3DetailsParameter = applicantLevel3Details.HasValue ?
                new ObjectParameter("applicantLevel3Details", applicantLevel3Details) :
                new ObjectParameter("applicantLevel3Details", typeof(int));
            ...
            var medalsParameter = medals.HasValue ?
                new ObjectParameter("medals", medals) :
                new ObjectParameter("medals", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spApplicantLevel3AddUpdate", applicantLevel3DetailsParameter, inductionIdParameter, phaseIdParameter, applicantIdParameter, typeIdParameter, disciplineIdParameter, imageCertificateParameter, specialityIdParameter, medalsParameter, passingDateParameter, obtainMarksParameter, totalMarksParameter);
        }
        ...
        public virtual ObjectResult<spJoinedApplicantByHospitalSearch_Result> spJoinedApplicantByHospitalSearch(Nullable<int> pageNum, Nullable<int> top, Nullable<int> userId, Nullable<int> specialityId, Nullable<int> hospitalId, Nullable<int> attachStatusId, string search)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spJoinedApplicantByHospitalSearch_Result>("spJoinedApplicantByHospitalSearch", pageNumParameter, topParameter, userIdParameter, specialityIdParameter, hospitalIdParameter, attachStatusIdParameter, searchParameter);
        }
        ...
        public virtual int spHistoryApplicantCertificate(Nullable<int> applicantCertificateTypeId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantCertificate", applicantCertificateTypeIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantDegree(Nullable<int> applicantId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantDegree", applicantIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantDegreeMarks(Nullable<int> degreeMarksId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantDegreeMarks", degreeMarksIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantDistinction(Nullable<int> applicantDistinctionId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantDistinction", applicantDistinctionIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantExperience(Nullable<int> applicantExperienceId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantExperience", applicantExperienceIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantHouseJob(Nullable<int> houseJodId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantHouseJob", houseJodIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantInfo(Nullable<int> applicantId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantInfo", applicantIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantInfoDualNational(Nullable<int> applicantId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantInfoDualNational", applicantIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantResearchPaper(Nullable<int> applicantResearchId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantResearchPaper", applicantResearchIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantUpdate(Nullable<int> applicantId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantUpdate", applicantIdParameter, adminIdParameter);
        }


        public virtual int spHistoryApplicantVoucher(Nullable<int> applicantId, Nullable<int> adminId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryApplicantVoucher", applicantIdParameter, adminIdParameter);
        }


        public virtual int spHistoryConstant(Nullable<int> constantId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryConstant", constantIdParameter);
        }


        public virtual int spHistoryEmailTemplate(Nullable<int> emailTemplateId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHistoryEmailTemplate", emailTemplateIdParameter);
        }


        public virtual int spHospitalDisciplineCreateHistory1(Nullable<int> id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spHospitalDisciplineCreateHistory1", idParameter);
        }
